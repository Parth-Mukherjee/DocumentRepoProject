...
namespace DocumentRepository.Data
{
    public class ApplicationDbContext : DbContext
    {
        ...
        public List<DocumentDetailListViewModel> usp_getPagenatedDocumentList(int pageIndex, int pazeSize)
        {
            ...
            List<DocumentModel> documentList =  documentModels.FromSqlRaw("EXEC [dbo].[usp_getPagenatedDocumentList] @PageIndex, @PageSize", parameters).ToList();
